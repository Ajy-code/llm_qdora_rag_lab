# Fine-tuning sur tout le dataset avec la méthode DoRa (Tous les paramètres utilisé avec la méthode LoRa ont été gardé)
import os
import json
...
output_dir=os.path.join(dossier_script,"..","data","dora_sft")
